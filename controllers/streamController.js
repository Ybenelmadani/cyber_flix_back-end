...
const buildVirtualEmbedStream = ({
  ...
  return {
    ...
    poster: "",
    sources: [
      buildAutoEmbedSource(),
      {
        name: "VidLink",
        provider: "vidlink",
        url: mediaType === "movie" ? `https://vidlink.pro/movie/${tmdbId}` : `https://vidlink.pro/tv/${tmdbId}/${seasonNumber}/${episodeNumber}`,
        type: "embed",
        quality: "Auto",
        language: "VO",
        isPremium: false,
      ...
      },
      {
        name: "VidSrc",
        provider: "vidsrc",
        url: mediaType === "movie" ? `https://vidsrc.xyz/embed/movie?tmdb=${tmdbId}` : `https://vidsrc.xyz/embed/tv?tmdb=${tmdbId}&season=${seasonNumber}&episode=${episodeNumber}`,
        type: "embed",
        quality: "HD",
        language: "VO",
        isPremium: false,
      ...
      },
      {
        name: "Embed.su",
        provider: "embedsu",
        url: mediaType === "movie" ? `https://embed.su/embed/movie/${tmdbId}` : `https://embed.su/embed/tv/${tmdbId}/${seasonNumber}/${episodeNumber}`,
        type: "embed",
        quality: "Auto",
        language: "VO",
        isPremium: false,
      ...
      },
      {
        name: "AutoEmbed",
        provider: "autoembed",
        url: mediaType === "movie" ? `https://autoembed.cc/movie/tmdb-${tmdbId}` : `https://autoembed.cc/tv/tmdb-${tmdbId}-${seasonNumber}-${episodeNumber}`,
        type: "embed",
        quality: "Auto",
        language: "VO",
        isPremium: false,
